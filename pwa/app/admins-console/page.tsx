  ...
  async function onSubmit(values: AdminFormValues) {  
    ...
    try {  
      ...
      if (error.code === 'auth/email-already-in-use') {  
        setError('Este email ya está en uso en Firebase Authentication');  
      } else {  
        setError('Error añadiendo administrador: ' + error.message);  
      }  
    } finally {  
      setSaving(false);  
    }  
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>  
        ...
        <div style={{    
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{     
            ...
            >    
              {saving ? 'Añadiendo...' : 'Añadir Administrador'}    
            </button>    
          </form>    
        </div>    
